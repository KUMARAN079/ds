...
df = pd.read_csv(r'C:\Users\kumaram\Desktop\Airbnb analysis project\Airbnb.csv')
...
if select == 'Home':
    image1= Image.open(r"C:\Users\kumaram\Downloads\airbnb.png")
    st.image(image1)
...
if select == 'Data Exploration':
    ...
    with tab1:
        ...
        with col1:
            ...
            room_ty = st.selectbox('Select the Room Type',df['room_type'].unique())

            df2 = df1[df1['room_type'] == room_ty]
            df2.reset_index(drop = True, inplace = True)

            df_bar = df2.groupby('property_type').agg({'price':'sum',
                                                        'number_of_reviews':'sum',
                                                        'review_scores':'mean'})

            df_bar.reset_index(inplace = True)

            fig_bar = px.bar(df_bar, x='property_type', y='price', title = 'PRICE FOR PROPERTY_TYPE',
                 hover_data = ['review_scores', 'number_of_reviews'], width = 600, height = 500,
        ...
        with col2:
            ...
            df3 = df2[df2['property_type'] == proper_ty]
    ...
    with tab2:
        ...
        with col1:
            ...
            property_ty = st.selectbox('Select the Property Type_a',df['property_type'].unique())
            ...
            df_a_sunb_30 = px.sunburst(df2, path=['room_type', 'bed_type', 'is_location_exact'],
                                       ...
                                       title = 'Availability_30', color_discrete_sequence = px.colors.sequential.Peach_r)
        ...
        with col2:
            ...
            df_a_sunb_60 = px.sunburst(df2, path=['room_type', 'bed_type', 'is_location_exact'],
                                       ...
                                       title = 'Availability_60', color_discrete_sequence = px.colors.sequential.Blues_r)
        ...
        with col1:
            ...
            df_a_sunb_90 = px.sunburst(df2, path=['room_type', 'bed_type', 'is_location_exact'],
                                       ...
                                       title = 'Availability_90', color_discrete_sequence = px.colors.sequential.Aggrnyl_r)
        ...
        with col2:
            ...
            df_a_sunb_365 = px.sunburst(df2, path=['room_type', 'bed_type', 'is_location_exact'],
                                        ...
                                        title = 'Availability_365', color_discrete_sequence = px.colors.sequential.Greens_r)

            st.plotly_chart(df_a_sunb_365)

        room_ty_a = st.selectbox('Select the Room Type_a', df2['room_type'].unique())
        ...
        fig_df_mul_bar_a = px.bar(df3_a, x = 'host_response_time',
                                  y = ['availability_30', 'availability_60', 'availability_90',
                                       'availability_365'], title = 'AVAILABILITY BASED ON HOST RESPONSE TIME',
    ...
    with tab3:
        ...
        country_1 = st.selectbox('Select the Country_1',df['country'].unique())

        df_1 = df[df['country'] == country_1]
        df_1.reset_index(drop= True, inplace= True)

        proper_ty_1 = st.selectbox('Select the Property_type_1',df['property_type'].unique())
        ...
        sel_val= st.radio("Select the Price Range",[str(df2_1['price'].min())+' '+str('to')+' '+str(differ_max_min*0.30 + df2_1['price'].min())+' '+str("(30% of the Value)"),
        ...
        df_val_sel= select_the_df(sel_val)
        ...
        room_ty_1 = st.selectbox('Select the Room_Type_1', df_val_sel["room_type"].unique())

        df_val_sel_rt = df_val_sel[df_val_sel["room_type"] == room_ty_1]
    ...
    with tab4:
        ...
        fig_4 = px.scatter_map(df, lat='latitude', lon='longitude', color='price', size='accommodates',
                color_continuous_scale= "rainbow",hover_name='name',range_color=(0,49000), map_style="carto-positron",
                zoom=1)
    ...
    with tab5:
        ...
        df2_t = df1_t[df1_t['property_type'] == 'Apartment']
